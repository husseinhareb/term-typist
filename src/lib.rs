...
struct App {
    ...
    mode: Mode,
    samples: Vec<(u64, f64)>, // (second, wpm) samples
}
...
pub fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    'mainloop: loop {
        ...
        terminal.draw(|f| {
            ...
            let sel = Paragraph::new(Spans::from(spans))
